// Package microstackd provides the daemon.
package main
...
import (
	...
	"github.com/hemanthnakkina/microstack-cluster/api"
	"github.com/hemanthnakkina/microstack-cluster/database"
	"github.com/hemanthnakkina/microstack-cluster/version"
)
...
func (c *cmdDaemon) Command() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "microstackd",
		Short:   "Cluster daemon for microstack",
...
func (c *cmdDaemon) Run(cmd *cobra.Command, args []string) error {
	...
	// h := &config.Hooks{}
	// h.OnBootstrap = microstack.Bootstrap
	// h.OnJoin = microstack.Join
